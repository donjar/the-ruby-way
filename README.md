...
gem install rails
```
Afterwards try opening `irb` in your terminal. You should see a prompt like: `2.3.3 :001 >` If it's not working, just use https://repl.it for this moment.
...
Check https://ruby-doc.org/core-2.3.3/String.html. These are some things that you can do with Ruby:
```ruby
> 'hello'.delete('l')
=> 'heo'
